    ...
    const svgArray = [
        {
            ...
            gradient: "linear-gradient(225deg, rgba(73,0,16,1) 0%, rgba(221,0,49,1) 100%)",
            boxwidth: "340px",
            boxheight: "90px",
            align: "flex-end"
        },
        {
            ...
            borderColor: "transparent",
            gradient: "radial-gradient(circle, rgba(0,58,97,1) 0%, rgba(0,122,204,1) 100%)",
            boxwidth: "150px",
            boxheight: "170px",
            align: "center"
        },
        ...
        },
        {
            ...
            borderColor: "transparent",
            gradient: "linear-gradient(225deg, rgba(139,126,18,1) 0%, rgba(247,223,30,1) 100%)",
            boxwidth: "340px",
            boxheight: "90px",
            align: "flex-end"
        },
        {
            ...
            borderColor: "transparent",
            gradient: "radial-gradient(circle, rgba(61,134,154,1) 0%, rgba(97,218,251,1) 100%)",
            boxwidth: "150px",
            boxheight: "170px",
            align: "center"
        },
        ...
        },
        {
            ...
            backgroundColor: "#F7DF1E",
            borderColor: "transparent",
            gradient: "radial-gradient(circle, rgba(139,126,18,1) 0%, rgba(247,223,30,1) 100%)",
            boxwidth: "150px",
            boxheight: "170px",
            align: "center"
        },
        {
            ...
            borderColor: "transparent",
            gradient: "radial-gradient(circle, rgba(27,78,13,1) 0%, rgba(65,184,32,1) 100%)",
            boxwidth: "150px",
            boxheight: "85px",
            align: "flex-end"
        },
        {
            ...
            borderColor: "transparent",
            gradient: "linear-gradient(225deg, rgba(85,102,33,1) 0%, rgba(164,198,57,1) 100%)",
            boxwidth: "340px",
            boxheight: "95px",
            align: "flex-end"
        },
    ...
    return (
        <>
            <div className="SkillComponent">
                {newList.map(({ id, title, Image, backgroundColor, borderColor, gradient, boxheight, boxwidth, align }) =>
                (<SkillButton
                    key={id}
