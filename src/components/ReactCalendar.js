        ...
        <div className="containerCalendarCard">
            ...
            <div className="calendarComponentContainer">
                ...
                <div className="containerAppuntamenti">
                    {notificationsDb[0].accepted && <div className="appuntamento" key={notificationsDb[0].id}>
                    ...
                    {notificationsDb[1].accepted && <div className="appuntamento" key={notificationsDb[1].id}>
                        <div id="placeholderJob">
