...
export function Card({user, id}){
    ...
    return(
            <div className="Card">
                ...
                <motion.div ref={ref} className={"CardProfileDescriptionContainer " + descriptionClass} drag="y" dragConstraints={{top: -200, bottom: 0,}} dragElastic={0} onDragEnd={DescriptionOpener}>
